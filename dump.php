...
require_once($CFG->dirroot.'/grade/export/ncmgradeapproval/grade_export_pdf.php');
...
require_capability('gradeexport/ncmgradeapproval:publish', $context);
...
$export = new grade_export_pdf($course, $groupid, $formdata);
$export->print_grades();
